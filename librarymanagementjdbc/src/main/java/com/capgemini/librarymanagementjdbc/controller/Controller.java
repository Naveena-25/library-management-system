											...
											case 5:
												try {
													...
													for (BookDetails b : list) {
														...
														System.out.println("bookPublisher......"+b.getPublisher());
														System.out.println("-------------------------------");
													}
												}catch (Exception e) {
											...
											case 6:
												try {
													...
													for (RequestInfo info : requestInfos) {
														...
														System.out.println("User Name -------- " + info.getInfo().getUserName());
								...
								try {
									...
									do {
										...
										case 2:
											...
											user.setId(userId);
											try {
											//	RequestInfo request = service.bookRequest(userId, bookId);
												System.out.println("Request placed to admin");
												//System.out.println("User Id-----" + request.getInfo().getId());
												//System.out.println("Book Id-----" + request.getBookdetails().getBookId());
												//System.out.println("issued........."+request.isIssued());
											} catch (Exception e) {
